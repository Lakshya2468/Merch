...
interface Product {
  ...
  imageUrl?: string
  category: string
  designId: number // Design that comes with this product
  createdAt: string
}
...
const demoProducts: Product[] = [
  ...
  },
  {
    ...
    stock: 200,
    category: 'stickers',
    designId: 4, // Minimalist Geometry
    imageUrl:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our collection of custom merchandise. High-quality products
...
export default function ProductsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Products Content wrapped in Suspense */}
      <Suspense
        fallback={
